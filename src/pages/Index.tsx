...
import { QuizQuestion, quizQuestions, badges, securityTips, Badge as BadgeType, SecurityTip as SecurityTipType } from "@/data/quizData";
...
type QuizState = "intro" | "progress" | "results";
...
const Index = () => {
  ...
  const generatePersonalizedTips = useCallback(() => {
    const tipsToShow: SecurityTipType[] = [];
          ...
          <div className="animate-fade-in">
            <div className="cyber-card p-8 max-w-2xl mx-auto">
              ...
              <p className="text-lg mb-6 text-cyber-light">
                Test your knowledge and learn important cybersecurity tips!
              </p>
